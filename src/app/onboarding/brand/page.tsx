...
import { Search, ShieldCheck, Clock, ArrowRight, CheckCircle2 } from 'lucide-react'
...
const steps = [
  ...
  },
  {
    ...
    icon: <Clock className="text-emerald-500" size={40} />,
  ...
  },
  {
    ...
    icon: <ShieldCheck className="text-amber-500" size={40} />,
